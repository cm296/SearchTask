// this is a copy of TimTurkTools, with a few extra helper functions

// Alvarezlab
function GetSubmitLocation() {	
	var submitTo = turkGetParam( 'turkSubmitTo', 'https://workersandbox.mturk.com' );
	submitTo = decodeURIComponent(submitTo) + "/mturk/externalSubmit";
	return submitTo;
}
